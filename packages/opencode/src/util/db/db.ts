...
// Tables are managed by Drizzle ORM, so this function is no longer needed
export function ensureTablesExist(_dbPath: string = "project-index.db") {
  // No-op: Drizzle ORM handles table creation based on schema
  console.log("ensureTablesExist is deprecated with bun:sqlite and Drizzle ORM");
}